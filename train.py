...
parser.add_argument('--nepoch', type=int, default=100000000, help='number of epochs to train for')
...
parser.add_argument('--valInterval', type=int, default=1000000, help='Interval to be displayed')
